...
#create instalation point
    ...
    payload = json.dumps(Create_Order_Locators.payload_create_installation_point1)
...
#set installation point
    payload = Create_Order_Functions.payload_set_installation_point1(self, instPointObjectId=point_id)
